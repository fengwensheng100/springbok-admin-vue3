    ...
    <el-dialog title="商品列表" width="60%" v-model="dialogTableVisible">
      ...
      <div>
        ...
        >
          ...
          <el-table-column prop="itemCode" label="商品编码" width="200">
          </el-table-column>
          <el-table-column prop="itemSaleName" label="商品名称">
          </el-table-column>
        </el-table>
...
<script setup name="ItemSaleTable">
import { pageItemSale } from "../../api/itemSale";
